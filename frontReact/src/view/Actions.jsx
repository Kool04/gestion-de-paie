...
export default function Action() {
    ...
    useEffect(() => {
        document.title = "Ajouter action- Gestion de payement"; // Mettez ici le titre que vous souhaitez
    }, []);
    ...
    const onSubmitChange = async (e) => {
        ...
        try {
            const response = await axios.post(
                "http://127.0.0.1:8000/api/ajouterAction",
                userField
            );
        ...
        <div className="px-6 py-8 bg-white isolate sm:py-5 lg:px-8">
            ...
            <div className="max-w-2xl mx-auto text-center">
                ...
                <p className="mt-2 text-lg leading-8 text-gray-600">
                    vous pouvez ajouter des actions comme prendre une
